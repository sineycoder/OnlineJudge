...
public class CommonServiceImp implements CommonService{
    ...
    @Override
    public List<Notice> queryContestStatus(Date date) throws Exception {
        return commonMapper.selectContestStatus(date);
    }

    @Override
    public int querySubmitsCountsByResult(String result) throws Exception {
        return commonMapper.selectSubmitsCountsByResult(result);
    }
    ...
    @Override
    public int queryProblemsCounts(ProblemRecords problemRecords) throws Exception {
        return commonMapper.selectProblemsCounts(problemRecords);
    }
    ...
    @Override
    public int queryContestTotals(Boolean contestVisible) throws Exception {
        return commonMapper.selectContestTotals(contestVisible);
    }
